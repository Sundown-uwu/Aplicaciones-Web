package com.List.List.service;

import com.List.List.dto.CreateUserDTO;
...
public class UserService {
    ...
    //Constructor para poblar datos oficiales
    public UserService() {
    ...
    public List<User> findAll(int page, int size, String search){
        ...
        if (search != null && !search.isBlank()) {
            ...
            all = all.stream()
                    .filter(u -> u.getName().toLowerCase().contains(s) || u.getEmail().toLowerCase().contains(s))
